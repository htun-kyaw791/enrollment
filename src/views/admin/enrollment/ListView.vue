        ...
        <div class=" overflow-x-auto">
          <div class="min-w-full inline-block align-middle">
            <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
              <div class="">
                  <h1 class="text-3xl font-semibold text-gray-800">Enrollment</h1>
              </div>
                  ...
                  <table class=" min-w-full rounded-xl">
                      <thead>
                          <tr class="bg-gray-50">
                              ...
                              <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Section_id</th>
                      ...
                      <tbody class="divide-y divide-gray-300" v-for="data in enrollmentData" :key="data.id">
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                              ...
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{ data.section_id }}</td> 
                              ...
                              <td class=" p-5 ">
                                  <div class="flex items-center gap-1">
                                      <router-link to="/admin/enrollmentedit" @click="storeSessionId(data.id)"
                                      ...
                                      /
                                      <button @click="deleteEnrollment(data.id)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
  ...
  export default {
    ...
    setup() {
      ...
      const fetchenrollmentData = async () => {
        ...
        {
            enrollmentData.value = response.data.data; 
        }
        else
        {
      ...
      { 
        try{
          const deleteData = await api.delete(`/enrollment/delete/${id}`);
          console.log(deleteData);
          if (deleteData.status === 200) 
          {
            enrollmentData.value = enrollmentData.value.filter(data => data.id !== id)
            notification.notify(
              {
                text:'enrollment is successfully deleted.',
                type: 'warn'
              }
            );
          ...
          else 
          {
            notification.notify(
              {
                text:'Error during delete enrollment',
                type: 'error'
              }
            );
            notification.notify.close()
        ...
        {
          console.log('enrollment deleting error', error);
          notification.notify(
            {
              text:'Error during delete enrollment',
              type: 'error'
      ...
      onMounted(() => {
        fetchenrollmentData(); // Call fetch function when component mounts
      });
