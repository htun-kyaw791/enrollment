<template>
            ...
            <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
              ...
              <div class="overflow-hidden ">
                  ...
                  <table class=" min-w-full rounded-xl">
                      ...
                      <tbody class="divide-y divide-gray-300" v-for="data in sectionData" :key="data.id">
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                              ...
                              <td class=" p-5 ">
                                  <div class="flex items-center gap-1">
                                      <router-link to="/admin/sectionedit" @click="storeSessionId(data.id)"
                                      ...
                                      /
                                      <button @click="deleteSection(data.id)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
  ...
  export default {
    ...
    setup() {
      ...
      { 
        try{
          const deleteData = await api.delete(`/section/delete/${id}`);
          if (deleteData.status === 200) 
          {
            sectionData.value = sectionData.value.filter(data => data.id !== id)
            notification.notify(
              {
      ...
      onMounted(() => {
        fetchsectionData(); // Call fetch function when component mounts
      });
