          ...
          <div class="min-w-full inline-block align-middle">
            <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
              ...
              <div class="overflow-hidden ">
                  <div v-if="!paymentTypeData.length === 0">
                  ...
                  <table class=" min-w-full rounded-xl">
                      ...
                      <tbody class="divide-y divide-gray-300" v-for="data in paymentTypeData" :key="data.paymenttypeid">
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{ data.paymenttypeid }}</td>
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{ data.paymenttypename }} </td>
                              <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                <img 
                                    :src="`http://localhost:8000/uploads/paymentType/${data.paymenttypeimage}`" 
                              ...
                              <td class=" p-5 ">
                                  <div class="flex items-center gap-1">
                                      ...
                                      /
                                      <button @click="deletePaymentType(data.paymenttypeid)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
  ...
  export default {
    ...
    setup() {
      ...
      const fetchPaymentTypeData = async () => {
        ...
        {
          paymentTypeData.value = response.data.data; 
          console.log(paymentTypeData.value);
        }
        else
        {
      ...
      { 
        try{
          const deleteData = await api.delete(`/payment-type/delete/${paymenttypeid}`);
          console.log(deleteData);
          if (deleteData.status === 200) 
          {
            paymentTypeData.value = paymentTypeData.value.filter(data => data.paymenttypeid !== paymenttypeid)
            notification.notify(
              {
                text:'Payment Type is successfully deleted.',
                type: 'warn'
              }
            );
          ...
          else 
          {
            notification.notify(
              {
                text:'Error during delete payment type',
                type: 'error'
              }
            );
            notification.notify.close()
        ...
        {
          console.log('Payment Type deleting error', error);
          notification.notify(
            {
              text:'Error during delete payment type',
              type: 'error'
