      ...
      <div class=" overflow-x-auto">
        <div class="min-w-full inline-block align-middle">
          <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
            <div class="">
                <h1 class="text-3xl font-semibold text-gray-800">Payment</h1>
            </div>
            ...
            <div class="overflow-hidden ">
                ...
                <table class=" min-w-full rounded-xl">
                    ...
                    <tbody class="divide-y divide-gray-300" v-for="data in paymentData" :key="data.id">
                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                <img 
                                    :src="`http://localhost:8000/uploads/evidence/${data.evidence_image}`" 
                            ...
                            <td class=" p-5 ">
                                <div class="flex items-center gap-1">
                                    <router-link to="/admin/paymentedit" @click="storeSessionId(data.id)"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      fetchpaymentData(); // Call fetch function when component mounts
    });
