    ...
    <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-yellow-500 text-white p-4 rounded shadow">
          ...
          <p class="text-2xl font-bold">${{ paymentSummary.total_revenue }}</p>
        </div>
        <div class="bg-red-500 text-white p-4 rounded shadow">
          <h2 class="text-lg">Pending Payments</h2>
          <p class="text-2xl font-bold">{{ paymentSummary.pending_payments }}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="bg-white p-4 rounded shadow">
          ...
          <line-chart :data="enrollmentChartData" />
        </div>
        <div class="bg-white p-4 rounded shadow">
          <h2 class="text-lg font-bold mb-2">Revenue by Payment Type</h2>
          <pie-chart :data="paymentTypeChartData" />
        </div>
      </div>
