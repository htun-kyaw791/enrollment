<template>
        ...
        <div class=" overflow-x-auto">
          <div class="min-w-full inline-block align-middle">
            <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
              <div class="">
                  <h1 class="text-3xl font-semibold text-gray-800">Teacher</h1>
              </div>
              ...
              <div class="overflow-hidden ">
                  ...
                  <table class=" min-w-full rounded-xl">
                      ...
                      <tbody class="divide-y divide-gray-300" v-for="data in teacherData" :key="data.id">
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                              ...
                              <td class=" p-5 ">
                                  <div class="flex items-center gap-1">
                                      <router-link to="/admin/teacheredit" @click="storeSessionId(data.id)"
                                      ...
                                      /
                                      <button @click="deleteTeacher(data.id)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
  ...
  export default {
    ...
    setup() {
      ...
      { 
        try{
          const deleteData = await api.delete(`/teacher/delete/${id}`);
          console.log(deleteData);
          console.log("I am here");
          if (deleteData.status === 200) 
          {
            console.log("I am here");
            teacherData.value = teacherData.value.filter(data => data.id !== id)
          ...
          else 
          {
            notification.notify(
              {
                text:'Error during delete course',
                type: 'error'
              }
            );
            notification.notify.close()
        ...
        catch(error)
        {
          ...
          notification.notify(
            {
              text:'Error during delete section',
              type: 'error'
            }
          );
          notification.notify.close()      }
      ...
      onMounted(() => {
        fetchteacherData(); // Call fetch function when component mounts
      });
